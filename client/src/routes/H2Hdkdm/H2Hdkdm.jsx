...
var api = Config.host + "/api/H2Hs/generateDKDM"

class H2Hdkdm extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      form: {
          ...
          <div className="content flex" style={{paddingTop: 36}}>
            <Paper>
              <form className="content" style={{paddingTop: 12, paddingBottom: 24}}>
                ...
                <div style={{paddingTop: 16, paddingBottom: 8}}>
                  <InputLabel htmlFor="type">DK / DM</InputLabel>
                  <Select
                    native={false}
                  ...
                  >
                    <MenuItem value={0} style={{width: 200}}>DK</MenuItem>
                    <MenuItem value={1} style={{width: 200}}>DM</MenuItem>
                  </Select>
                </div>
            </form>
            </Paper>
