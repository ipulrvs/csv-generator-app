...
var api = Config.host + "/api/H2Hs/generateFK"

class H2Hfk extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      form: {
          ...
          <div className="content flex" style={{paddingTop: 36}}>
            <Paper>
              <form className="content" style={{paddingTop: 12, paddingBottom: 24}}>
                ...
                <TextField 
                  onChange={this.handleForm.bind(this, "sizeChild")} value={this.state.form.sizeChild}
                  id="totalData" type="number" label="Total Data Child" name="totalDataChild" margin="normal" fullWidth={true} placeholder="Total Child Data will be generated" />
