...
var api = Config.host + "/api/H2Hs/generateRDKM"

class H2Hrdkm extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      form: {
          ...
          <div className="content flex" style={{paddingTop: 36}}>
            <Paper>
              <form className="content" style={{paddingTop: 12, paddingBottom: 24}}>
                ...
                <div style={{paddingTop: 16, paddingBottom: 8}}>
                  <InputLabel htmlFor="type">RDK / RDM</InputLabel>
                  <Select
                    native={false}
                    value={this.state.form.type}
                    onChange={this.handleForm.bind(this, "type")}
                    input={<Input id="type" fullWidth={true} margin="normal" id="type" name="type"/>}
                  >
                    <MenuItem value={0} style={{width: 200}}>RDK</MenuItem>
                    <MenuItem value={1} style={{width: 200}}>RDM</MenuItem>
                  </Select>
